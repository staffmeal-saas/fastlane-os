...
function ProtectedLayout({ pageTitle, allowedRoles }: ProtectedLayoutProps) {
  ...
  if (
    allowedRoles &&
    profile &&
    !allowedRoles.includes(profile.platform_role)
  ) {
...
const ALL_ROLES: PlatformRole[] = [...ADMIN_ROLES, ...CLIENT_ROLES];
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Notifications" allowedRoles={ALL_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Dashboard" allowedRoles={CLIENT_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Stratégie" allowedRoles={CLIENT_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Campagnes" allowedRoles={CLIENT_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Actions" allowedRoles={CLIENT_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout
            pageTitle="Portefeuille de crédits"
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Documents" allowedRoles={CLIENT_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout
            pageTitle="Recharger des crédits"
            allowedRoles={CLIENT_ROLES}
          />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout pageTitle="Back-Office" allowedRoles={ADMIN_ROLES} />
        }
      >
      ...
      <Route
        element={
          <ProtectedLayout
            pageTitle="Onboarding Client"
            allowedRoles={ADMIN_ROLES}
          />
        }
      >
        <Route
          path="/admin/clients/onboarding"
